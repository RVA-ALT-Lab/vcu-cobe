<?php
/**
*	Template Name: Coursework Template
*
*
*/
	...
	<div class="content-area">
		...
		<div class="course-options">
			<?php
				...
				$cats = get_terms('cobe_course_type', $args);
				foreach($cats as $cat) {
		...
		<div class="course-area">
			<?php
				$args = array( 'post_type' => 'cobe_course', 'posts_per_page' => -1 );
				$courses_loop = new WP_query( $args );
				while ( $courses_loop->have_posts() ) : $courses_loop->the_post();
					$category = strip_tags( get_the_term_list($post->ID, 'cobe_course_type') );
